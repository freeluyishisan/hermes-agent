...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # CVE-2026-48710/48818/54283 — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.31",  # CVE-2026-53540/53539/53538 — FastAPI UploadFile/Form
    ),
