...
export const zh: Translations = {
  ...
  install: {
    ...
    connectExistingDesc: '将这个桌面应用连接到正在运行的远程 Hermes dashboard，而不是再安装一份本地 Hermes。',
    remoteUrlLabel: '远程 dashboard URL',
    remoteUrlPlaceholder: 'https://your-hermes-host.example.com',
    remoteTokenLabel: '会话令牌',
    remoteTokenPlaceholder: '粘贴 dashboard 会话令牌',
    remoteProbeIdle: '输入远程 dashboard URL 以检测其认证方式。',
    remoteProbeChecking: '正在检查远程网关…',
    remoteProbeFailed: '暂时无法访问该 Hermes dashboard。',
    remoteProbeOauth: '此网关使用浏览器登录。',
    remoteProbeToken: '此网关需要会话令牌。',
    remoteSignIn: '登录远程网关',
    remoteSignInWithProvider: provider => `使用 ${provider} 登录`,
    remoteSignInConnected: '远程登录已完成。',
    remoteSignInRequired: '连接此桌面应用前，请先完成远程登录。',
    remoteConnectFirst: '请先填写 URL，并完成登录或令牌输入。',
    remoteTest: '测试连接',
    remoteApplying: '连接中…',
    remoteConnect: '使用这个 Hermes 实例',
    remoteConnected: (baseUrl, version) => `已连接到 ${baseUrl}${version ? ` (${version})` : ''}。`,
    remoteSaved: '远程 Hermes 连接已保存。',
    remoteApplyFailed: '无法切换到该远程 Hermes 实例。',
    remoteProbeLabel: '连接类型',
    installCommand: '安装命令',
    copyCommand: '复制命令',
    viewDocs: '查看安装文档',
    installTo: '将安装到',
