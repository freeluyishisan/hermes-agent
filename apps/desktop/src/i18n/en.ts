...
export const en: Translations = {
  ...
  sidebar: {
    ...
    cloudInviteTokenPlaceholder: 'Invite token',
    cloudInviteAccept: 'Accept',
    cloudInviteAccepting: 'Accepting...',
    cloudChannelsListTitle: 'Available channels',
    cloudChannelsLoading: 'Loading channels...',
    cloudChannelsEmpty: 'No cloud channels yet.',
    cloudChannelsRefresh: 'Refresh',
    cloudChannelsRefreshing: 'Refreshing...',
    cloudChannelsClose: 'Close',
    cloudChannelsOwner: 'owner',
    cloudChannelsRead: 'read',
    cloudChannelsSeq: seq => `seq ${seq}`,
    cloudMessagesTitle: 'Cloud history',
    cloudMessagesPickChannel: 'Select a cloud channel.',
    cloudMessagesLoading: 'Loading messages...',
    cloudMessagesEmpty: 'No visible messages yet.',
    cloudMessagesRefresh: 'Refresh',
    cloudMessagesLoadMore: 'Load more',
    cloudMessagesLoadingMore: 'Loading...',
    cloudMessagesNoContent: '(empty message)',
    cloudParticipantsTitle: 'Roster',
    cloudParticipantsEmpty: 'No viewers',
    cloudHostOnline: 'host online',
    ...
    row: {
      ...
      inviteToCloud: 'Invite to cloud',
      cloudMembers: 'Cloud members',
      deleteCloudChannel: 'Delete cloud channel',
      rename: 'Rename',
      archive: 'Archive',
      ...
      inviteCloudTitle: 'Invite to cloud channel',
      inviteCloudDesc: 'Create a read-only invite for this shared chat.',
      inviteEmailPlaceholder: 'name@example.com',
      inviteCreate: 'Create invite',
      cloudMembersTitle: 'Cloud members',
      cloudMembersDesc: 'Current accounts with access to this shared chat.',
      cloudMembersEmpty: 'No invited members yet.',
      cloudMembersRefresh: 'Refresh',
      cloudMembersPermissionLabel: 'Cloud member permission',
      cloudMembersPermission: permission => ({ admin: 'admin', post: 'post', read: 'read' })[permission] || permission,
      cloudMembersRevoke: 'Revoke',
      cloudMembersRevokeConfirm: member => `Revoke cloud access for ${member}?`,
      cloudMembersSaving: 'Saving...',
      deleteCloudTitle: 'Delete cloud channel?',
      deleteCloudDesc:
        'The local chat stays here, but cloud history, invites, members, and live access are removed permanently.',
      deleteCloudConfirm: 'Delete cloud channel',
      deleteCloudDeleting: 'Deleting...',
