...
export const en: Translations = {
  ...
  install: {
    ...
    connectExistingDesc:
      'Point this desktop app at a running remote Hermes dashboard instead of installing a second local Hermes copy.',
    remoteUrlLabel: 'Remote dashboard URL',
    remoteUrlPlaceholder: 'https://your-hermes-host.example.com',
    remoteTokenLabel: 'Session token',
    remoteTokenPlaceholder: 'Paste the dashboard session token',
    remoteProbeIdle: 'Enter a remote dashboard URL to detect how it authenticates.',
    remoteProbeChecking: 'Checking remote gateway…',
    remoteProbeFailed: 'Could not reach that Hermes dashboard yet.',
    remoteProbeOauth: 'This gateway uses browser sign-in.',
    remoteProbeToken: 'This gateway expects a session token.',
    remoteSignIn: 'Sign in to remote gateway',
    remoteSignInWithProvider: provider => `Sign in with ${provider}`,
    remoteSignInConnected: 'Remote sign-in complete.',
    remoteSignInRequired: 'Finish remote sign-in before connecting this desktop app.',
    remoteConnectFirst: 'Add a URL and complete sign-in or token entry first.',
    remoteTest: 'Test connection',
    remoteApplying: 'Connecting…',
    remoteConnect: 'Use this Hermes instance',
    remoteConnected: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` (${version})` : ''}.`,
    remoteSaved: 'Remote Hermes connection saved.',
    remoteApplyFailed: 'Could not switch to that remote Hermes instance.',
    remoteProbeLabel: 'Connection type',
