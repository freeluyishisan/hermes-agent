...
export const zhHant = defineLocale({
  ...
  install: {
    ...
    connectExistingDesc: '將這個桌面應用程式連線到正在執行的遠端 Hermes dashboard，而不是再安裝一份本機 Hermes。',
    remoteUrlLabel: '遠端 dashboard URL',
    remoteUrlPlaceholder: 'https://your-hermes-host.example.com',
    remoteTokenLabel: '工作階段權杖',
    remoteTokenPlaceholder: '貼上 dashboard 工作階段權杖',
    remoteProbeIdle: '輸入遠端 dashboard URL 以偵測其驗證方式。',
    remoteProbeChecking: '正在檢查遠端閘道…',
    remoteProbeFailed: '目前無法連上該 Hermes dashboard。',
    remoteProbeOauth: '此閘道使用瀏覽器登入。',
    remoteProbeToken: '此閘道需要工作階段權杖。',
    remoteSignIn: '登入遠端閘道',
    remoteSignInWithProvider: provider => `使用 ${provider} 登入`,
    remoteSignInConnected: '遠端登入已完成。',
    remoteSignInRequired: '連線此桌面應用程式前，請先完成遠端登入。',
    remoteConnectFirst: '請先填入 URL，並完成登入或權杖輸入。',
    remoteTest: '測試連線',
    remoteApplying: '連線中…',
    remoteConnect: '使用這個 Hermes 執行個體',
    remoteConnected: (baseUrl, version) => `已連線到 ${baseUrl}${version ? ` (${version})` : ''}。`,
    remoteSaved: '遠端 Hermes 連線已儲存。',
    remoteApplyFailed: '無法切換到該遠端 Hermes 執行個體。',
    remoteProbeLabel: '連線類型',
    installCommand: '安裝指令',
    copyCommand: '複製指令',
    viewDocs: '檢視安裝文件',
    installTo: '將安裝至',
